...
android {
    namespace = "com.alignai.camera"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.alignai.camera"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.0"
...
dependencies {
    ...
    // Google ML Kit (Face Detection, Object Tracking, Image Labeling)
    ...
    // Coroutines & Guava (for CameraX ListenableFuture)
